        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventMyUser", x => new { x.EventsID, x.MyUsersId });
                    table.ForeignKey(
                        name: "FK_EventMyUser_AspNetUsers_MyUsersId",
                        column: x => x.MyUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventMyUser_Events_EventsID",
                        column: x => x.EventsID,
